...
function Card({username,btnText="visit me"}){ //default value of btnTExt //
    /*console.log("props",props);you can pass values from one component to another component and to use those values 
    you use props  but then u have to write props.username,props.btnText ,u can write function Card(props) */
    return(
<div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
      ...
      <div className="mb-4">
        ...
        <h2 className="text-xl font-bold text-white mb-2 group-hover:text-gray-300 transition-colors duration-200">
          {username}{/*make sure to write in curly brace to get the variable value*/}
        </h2>
      </div>
